...
/datum/bodypart_overlay/mutant/proc/can_draw_head(var/mob/living/carbon/human/wearer, key)
...
/datum/bodypart_overlay/mutant/horns/can_draw_on_bodypart(obj/item/bodypart/bodypart_owner)
	return can_draw_head(bodypart_owner.owner, feature_key)
...
/datum/bodypart_overlay/mutant/proc/can_draw_chest(var/mob/living/carbon/human/wearer, key)
...
/datum/bodypart_overlay/mutant/wings/can_draw_on_bodypart(obj/item/bodypart/bodypart_owner)
	return can_draw_chest(bodypart_owner.owner, feature_key)

/datum/bodypart_overlay/mutant/wings/moth/can_draw_on_bodypart(obj/item/bodypart/bodypart_owner)
	return can_draw_chest(bodypart_owner.owner, "wings") // moth wings are weird so we'll have to do this

/datum/bodypart_overlay/mutant/tail/can_draw_on_bodypart(obj/item/bodypart/bodypart_owner)
	return can_draw_chest(bodypart_owner.owner, feature_key_sprite) // so are tails
